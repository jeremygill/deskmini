        ...
        if (callITButton) {
          callITButton.addEventListener('click', (event) => {
            ...
            if (platform.includes('cisco')) {
              ...
              // ✅ Windows platform
              window.open(
                'https://as.microsoft.com/l/meetup-join/19%3ameeting_ZjkzYWVjOWMtNTRhMy00MjgyLWEwZjAtOTM0MTgxM2RhNmMw%40thread.v2/0?context=%7b%22Tid%22%3a%2293b0ec50-fc3f-47ed-9345-9ffc6012541c%22%2c%22Oid%22%3a%22f4191fbd-c7c1-4fa0-8679-d380e280aebf%22%7d',
                '_blank'
              );
            }
          });
